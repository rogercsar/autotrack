...
const Register: React.FC = () => {
  ...
  const [selectedUserType, setSelectedUserType] = useState<UserType>(UserType.BASIC);
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Escolha seu plano e comece a gerenciar seus veículos</p>
        </div>
